...
public class lottery 
{
	...
	public static void main(String[] args) 
	{
		...
		guess2 = Integer.parseInt(JOptionPane.showInputDialog(null, "Guess a number between " + low + " and " + (high-1)));
		guess3 = Integer.parseInt(JOptionPane.showInputDialog(null, "Guess a number between " + low + " and " + (high-1)));
